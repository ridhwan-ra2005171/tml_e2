...
This works well against content-agnostic watermarks, but it hits a wall with content-adaptive neural ones. (those embed differently depending on the image, so simple averaging can't fully recover them._)
